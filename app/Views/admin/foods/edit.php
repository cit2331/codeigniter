                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Sửa món ăn</h4>
                        </div>
                        ...
                        <?php endif ?>
                        <div class="card-body">
                            <form action='foods\update' method='post' enctype="multipart/form-data">
                                <input type="hidden" name="d_id" value="<?=$food['d_id']?>"/>  
                                <div class="form-body">
                                    <hr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">Mô
                                                    tả</label>
                                                <input type="text" name="slogan" value="<?=$food['slogan']?>" class="form-control form-control-danger">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row p-t-20">
